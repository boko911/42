...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/18 13:20:08 by nbuhler           #+#    #+#             */
/*   Updated: 2016/11/18 13:20:10 by nbuhler          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		ft_len_word(char const *s, char c, int cword)
{
	int	i;
	int	d;
	int	word;
